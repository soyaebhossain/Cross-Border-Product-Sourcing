...
export default function AdminCatalogPage() {
  ...
  return <>
    <nav className="admin-subnav" aria-label={bn ? "Catalog section" : "Catalog sections"}><Link className="admin-subnav--active" href="/admin/catalog">{bn ? "পণ্য" : "Products"}</Link><Link href="/admin/catalog/categories">{bn ? "ক্যাটাগরি" : "Categories"}</Link><Link href="/admin/catalog/variants">{bn ? "ভ্যারিয়েন্ট" : "Variants"}</Link><Link href="/admin/catalog/media">{bn ? "ছবি" : "Product media"}</Link></nav>
